                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Pregnant</h6>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-weight-bolder text-center">
                                                <a class="btn btn-danger text-white px-3 mb-0"
                                                    href="{{ route('admin.pregnant.delete', ['id' => $item->id]) }}"><i
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.pregnant.store') }}" method="POST">
                    @csrf
        ...
        <div class="modal fade" id="edit{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.pregnant.update', $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="mb-3">
