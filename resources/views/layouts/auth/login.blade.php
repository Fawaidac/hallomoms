...
<body class="bg-gray-200">
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100" style="background-image: url('assets/img/bg3.png');">
                            ...
                            <div class="card-body">
                                <form role="form" class="text-start" action="{{ route('login.act') }}"
                                    ...
                                    <p class="mt-4 text-sm text-center">
                                        Have a nice day
                                        <a href="" class="text-primary text-gradient font-weight-bold"></a>
                                    </p>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white text-lg-start">
                                ...
                                <a href="" class="font-weight-bold text-white" target="_blank">Hellomoms Tim</a>
                                for a better web.
                            </div>
                        </div>
